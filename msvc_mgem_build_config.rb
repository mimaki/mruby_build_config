...
=begin
  ...
  # {:git => 'https://github.com/take-cheeze/mruby-clang-plugin.git'},  # build error (llvm-conffig) no clang/AST/AST.h
  ...
  # {:git => 'https://github.com/pbosetti/mruby-plplot.git'}, # build error plplot.obj
  ...
  # {:git => 'https://github.com/mattn/mruby-require.git'}, # build error (driver.obj)
  ...
  # {:git => 'https://github.com/monami-ya-mrb/mruby-serialport.git'},  # need mrb_ary_len
