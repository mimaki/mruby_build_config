...
[
  ...
  # {:git => 'https://github.com/hfm/mruby-aws-sigv4.git'}, # compile error (unistd.h)
  ...
  {:git => 'https://github.com/bggd/mruby-channel.git'}, 
  ...
  # {:git => 'https://github.com/take-cheeze/mruby-clang-plugin.git'},  # test crash(undefind method exc)
  ...
  # {:git => 'https://github.com/inokappa/mruby-consul.git'}, # need sys/time.h
  ...
  # {:git => 'https://github.com/udzura/mruby-etcd.git'}, # need sys/time.h
  ...
  # {:git => 'https://github.com/takumakume/mruby-file-access.git'},  # need POSIX
  ...
  # {:git => 'https://github.com/UniTN-Mechatronics/mruby-fsm.git'},  # syntax error
  ...
  # {:git => 'https://github.com/UniTN-Mechatronics/mruby-gsl.git'},  # build error (gsl.c,gsl.o)
  ...
  # {:git=> 'https://github.com/scalone/mruby-hmac'}, # test crash
  ...
  # {:git => 'https://github.com/matsumotory/mruby-httprequest.git'}, # need sys/time.h
  ...
  # {:git => 'https://github.com/katzer/mruby-logger.git'}, # test abort
  ...
  # {:git => 'https://github.com/scalone/mruby-miniz.git'}, # need unistd.h
  ...
  # {:git => 'https://github.com/pepabo/mruby-msd.git'},  # uname error net.o faild
  ...
  # {:git => 'https://github.com/luisbebop/mruby-polarssl.git'},  # cl error /W
  ...
  # {:git => 'https://github.com/hfm/mruby-publicsuffix.git'}, # zgip
  ...
  # {:git => 'https://github.com/ksss/mruby-rake.git'}, # need config.h
  ...
  # {:git => 'https://github.com/takumakume/mruby-renice.git'},# need sys/time.h
  # {:git => 'https://github.com/mattn/mruby-require.git'}, # need unistd.h
