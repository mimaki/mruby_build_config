...
=begin
  ...
  # {:git => 'https://github.com/Asmod4n/mruby-c-ext-helpers.git'}, # Crash(1)
  ...
  # {:git => 'https://github.com/pyama86/mruby-capacity.git'},  # KO(3)
  ...
  # {:git => 'https://github.com/matsumotory/mruby-changefinder.git'},  # KO(1)
  ...
  # {:git => 'https://github.com/christopheraue/m-ruby-concurrently.git'}, # KO(1) Crash(5)
  ...
  # {:git => 'https://github.com/ksss/mruby-file-stat.git'},  # KO(3)
  ...
  # {:git=> 'https://github.com/scalone/mruby-hmac'}, # Crash(2)
  ...
  # {:git => 'https://github.com/ppibburr/mruby-javascriptcore.git'}, # test aborted (const FFI)
  ...
  # {:git => 'https://github.com/attm2x/m2x-mruby.git'}, # test aborted
  ...
  # {:git => 'https://github.com/listrophy/mruby-matrix.git'},  # build error
  ...
  # {:git => 'https://github.com/pbosetti/mruby-merb.git'}, # Crash(1)
  ...
  # {:git => 'https://github.com/ksss/mruby-ostruct.git'},  # KO(1) Crash(9)
  ...
  # {:git => 'https://github.com/h2so5/mruby-pure-regexp.git'}, # test error
  ...
  # {:git => 'https://github.com/katzer/mruby-shelf-deflater.git'},# build error (mruby-r3)
  ...
  # {:git => 'https://github.com/y-ken/mruby-simplehttp-socket.git'},# build error (mruby-r3)
  ...
  # {:git => 'https://github.com/ksss/mruby-stringio.git'}, # KO(1) Crash(7)
  ...
  # {:git => 'https://github.com/mimaki/mruby-tiny-io.git'},  # KO(3) Crash(1)
