...
[
  ...
  # {:git => 'https://github.com/iij/mruby-aws-s3.git', :lib => 'pcre'},  # test KO(1) crush(1)
  {:git => 'https://github.com/hfm/mruby-aws-sigv4.git'},
  ...
  # {:git => 'https://github.com/matsumotory/mruby-http2.git'}, # build error (./configure failed)
  ...
  {:git => 'https://github.com/scalone/mruby-miniz.git'}, # test KO(5)
  ...
  # {:git => 'https://github.com/matsumotory/mruby-oauth.git', :lib => 'pcre'}, # test KO(1)
  ...
  # {:git => 'https://github.com/katzer/mruby-shelf.git', :lib => 'pcre'},  # test hangup
  ...
  # {:git => 'https://github.com/matsumotory/mruby-vedis.git'}, # test KO(7)
  ...
  # {:git => 'https://github.com/katzer/mruby-yeah.git', :lib => 'pcre'}, # test KO(1)
