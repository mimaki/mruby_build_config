...
=begin
  ...
  {:git => 'https://github.com/hfm/mruby-aws-sigv4.git'}, # build error
  ...
  # {:git => 'https://github.com/mattn/mruby-gntp.git'}, # test KO(1) crach(18)
  ...
  # {:git => 'https://github.com/take-cheeze/mruby-leveldb.git'}, # strdup
  ...
  # {:git => 'https://github.com/dabroz/mruby-perlin-noise.git'}, # need mruby-mtest/mrbgem.rake
  ...
  # {:git => 'https://github.com/nsheremet/mruby-pong.git'}, # build error (polarssl.c)
  # {:git => 'https://github.com/udzura/mruby-posix_ipc.git'},  # test abort
  ...
  {:git => 'https://github.com/ksss/mruby-rake.git'}, # test KO(1)
  ...
  # {:git => 'https://github.com/takumakume/mruby-renice.git'},# test KO(3) crach(4)
  {:git => 'https://github.com/mattn/mruby-require.git'},
  {:git => 'https://github.com/ksss/mruby-research.git'}, 
  # {:git => 'https://github.com/harasou/mruby-resource.git'},  # test KO(1) crush(2)
  {:git => 'https://github.com/scalone/mruby-ripemd.git'},
  # {:git => 'https://github.com/emsk/mruby-romajify.git'}, # build error (reggnu.c)
  # {:git => 'https://github.com/schmurfy/mruby-rubyffi-compat.git'}, # need ffi.h
  {:git => 'https://github.com/haconiwa/mruby-seccomp.git'},  # need asm/unistd.h
  ...
  # {:git => 'https://github.com/katzer/mruby-sftp.git'}, # Permission denied
  {:git => 'https://github.com/mattn/mruby-sha1.git'},
  {:git => 'https://github.com/h2so5/mruby-sha2.git'},
  # {:git => 'https://github.com/katzer/mruby-shelf.git', :lib => 'pcre'},  # test KO(1) / vs //
  # {:git => 'https://github.com/k0kubun/mruby-shellwords.git'},  # compile error (reggnu.c)
  # {:git => 'https://github.com/monochromegane/mruby-sidekiq-client.git'}, # Implicit declaration of　strerror_r and strdup
  ...
  # {:git => 'https://github.com/naritta/mruby-strptime.git'}, # build error (reggnu.o)
  ...
  # {:git => 'https://github.com/nsheremet/mruby-tbot.git'},  # build error (polarssl.c)
