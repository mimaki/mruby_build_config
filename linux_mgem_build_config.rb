JDK_PATH = File.join('/usr', 'lib', 'jvm', 'java-8-openjdk-amd64')
...
[
  ...
  # {:git => 'https://github.com/iij/mruby-aws-s3.git'},  # test crach(1)
  ...
  {:git => 'https://github.com/jbreeden/mruby-curses.git'}, 
  ...
  {:git => 'https://github.com/udzura/mruby-etcd.git', :lib => 'pcre'},
  ...
  {:git => 'https://github.com/pyama86/mruby-network-analyzer.git'},
  ...
  {:git => 'https://github.com/katzer/mruby-sftp.git'},
  {:git => 'https://github.com/appplant/mruby-sftp-glob.git'},
  {:git => 'https://github.com/mattn/mruby-sha1.git'},
  {:git => 'https://github.com/h2so5/mruby-sha2.git'},
  # {:git => 'https://github.com/katzer/mruby-shelf.git', :lib => 'pcre'},  # link error (R3)
  ...
  # {:git => 'https://github.com/mattn/mruby-sinatic.git'}, # test KO(1) Crash(1)
  ...
  # {:git => 'https://github.com/jbreeden/mruby-sqlite.git', :lib => ['dl', 'pthread']}, # link error (sqlite)
  # {:git => 'https://github.com/mattn/mruby-sqlite3.git'}, # Segmentation Fault
  {:git => 'https://github.com/katzer/mruby-ssh.git'},
  ...
  {:git => 'https://github.com/mattn/mruby-uv.git'},
