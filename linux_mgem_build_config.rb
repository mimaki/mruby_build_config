...
[
  ...
  # {:git => 'https://github.com/udzura/mruby-etcd.git'}, # test crush(9)
  ...
  # {:git => 'https://github.com/ppibburr/mruby-girffi-docgen.git'},  # compile error (ARGS_NONE)
  # {:git => 'https://github.com/ppibburr/mruby-girffi.git'}, # compile error (ARGS_NONE)
  ...
  # {:git => 'https://github.com/ppibburr/mruby-glib2.git'},  # compile error (ARGS_NONE)
  # {:git => 'https://github.com/chasonr/mruby-gmp-bignum.git'},  # need gmp.h
  {:git => 'https://github.com/mattn/mruby-gntp.git'},
  # {:git => 'https://github.com/ppibburr/mruby-gobject-introspection.git'},  # compile error (ARGS_NONE)
  # {:git => 'https://github.com/ppibburr/mruby-gobject.git'},  # compile error (mrb_voidp)
  ...
  # {:git => 'https://github.com/matsumotory/mruby-httprequest.git'}, # test crush(7)
  ...
  # {:git => 'https://github.com/Asmod4n/mruby-libsodium.git'}, # compile error (crypto_xxx)
  ...
  # {:git => 'https://github.com/ksss/mruby-method.git'}, # segmentation fault
  ...
  # {:git => 'https://github.com/luisbebop/mruby-polarssl.git'},  # test crush(7)
  ...
  # {:git => 'https://github.com/schmurfy/mruby-rubyffi-compat.git'}, # compile error (ARGS_NONE)
  ...
  # {:git => 'https://github.com/matsumotory/mruby-simplehttp.git'},  # test crush(7)
  ...
  # {:git => 'https://github.com/matsumotory/mruby-spdy.git'},  # build error (lib)
  {:git => 'https://github.com/k0kubun/mruby-specinfra.git'},
  # {:git => 'https://github.com/jbreeden/mruby-sqlite.git'}, # link error (sqlite)
  ...
  # {:git => 'https://github.com/ppibburr/mruby-webkit-1.git'}, # compile error (ARGS_NONE)
  # {:git => 'https://github.com/ppibburr/mruby-webkit-3.git'}, # compile error (ARGS_NONE)
  ...
  # {:git => 'https://github.com/Asmod4n/mruby-wslay' # compile error (ntohl())
  {:git => 'https://github.com/hone/mruby-yaml.git'},
  # {:git => 'https://github.com/katzer/mruby-yeah.git'}, # test crush(1)
