...
[
=begin
  # {:git => 'https://github.com/k0u5uk3/mruby-alarm.git'}, # test methodError
  ...
  # {:git => 'https://github.com/chasonr/mruby-bignum.git'},#test crach(3)
  ...
  # {:git => 'https://github.com/mobiruby/mruby-cfunc.git'},  # compile error (ARGS_NONE)
  # {:git => 'https://github.com/matsumotory/mruby-cgroup.git'},  # autoreconf error
  ...
  # {:git => 'https://github.com/take-cheeze/mruby-clang-plugin.git'},  # fatal error no clang/AST/AST.h
  ...
  # {:git => 'https://github.com/matsumotory/mruby-criu.git'}, #compile error criu/criu.h
  ...
  # {:git => 'https://github.com/matsumotory/mruby-disque.git'},  # test crush(53)
  ...
  {:git => 'https://github.com/matsumotory/mruby-fast-remote-check.git'}, # test KO(1) crush(3)
  {:git => 'https://github.com/mattn/mruby-fiberpool.git'}
  # {:git => 'https://github.com/takumakume/mruby-file-access.git'},  # test KO(5)
  ...
  # {:git => 'https://github.com/Asmod4n/mruby-getpass.git'}, # TCSASOFT not defined
  {:git => 'https://github.com/mame/mruby-gettimeofday.git'},
  # {:git => 'https://github.com/ppibburr/mruby-girffi-docgen.git'},  # need ffi.h
  # {:git => 'https://github.com/ppibburr/mruby-girffi.git'}, # compile error need ffi.h
  ...
  # {:git => 'https://github.com/ppibburr/mruby-glib2.git'},  # compile error need ffi.h
  # {:git => 'https://github.com/chasonr/mruby-gmp-bignum.git'},  # need gmp.h
  {:git => 'https://github.com/mattn/mruby-gntp.git'},
  # {:git => 'https://github.com/ppibburr/mruby-gobject-introspection.git'},  # compile error need ffi.h
  # {:git => 'https://github.com/ppibburr/mruby-gobject.git'},  # compile error need ffi.h
  ...
  # {:git => 'https://github.com/ppibburr/mruby-gtk2.git'}, # compile error (mrb_voidp) need ffi.h
  # {:git => 'https://github.com/ppibburr/mruby-gtk3.git'}, # compile error (ARGS_NONE) need ffi.h
  ...
  # {:git => 'https://github.com/schmurfy/host-stats.git'}, # compile error need ffi.h
  ...
  # {:git => 'https://github.com/FlavourSys/mruby-inotify.git'},  # compile error (initializer element is not constant)
  {:git => 'https://github.com/ksss/mruby-io-console.git'},
  {:git => 'https://github.com/ksss/mruby-io-copy_stream.git'}, # test abort
  ...
  # {:git => 'https://github.com/attm2x/m2x-mruby.git'},  # test crush(3)
  ...
  {:git => 'https://github.com/matsumotory/mruby-oauth.git'},
  ...
  # {:git => 'https://github.com/ksss/mruby-ostruct.git'},  # test KO(1) crush(4)
  ...
  # {:git => 'https://github.com/schmurfy/mruby-ping'} # need libnet.h
  ...
  {:git => 'https://github.com/udzura/mruby-posix_ipc.git'},
  # {:git => 'https://github.com/Asmod4n/mruby-postgresql.git'},#compile error (sha2-openssl.c)
  ...
  # {:git => 'https://github.com/katzer/mruby-r3.git'}, # build error (R3)
  ...
  # {:git => 'https://github.com/matsumotory/mruby-redis.git'}, # test crush(49)
  ...
  # {:git => 'https://github.com/mattn/mruby-sinatic.git'}, # build error (autogen.sh)
  ...
  # {:git => 'https://github.com/jbreeden/mruby-sqlite.git'}, # link error
  ...
  # {:git => 'https://github.com/naritta/mruby-strptime.git'},#NameError MTest
  ...
  # {:git => 'https://github.com/nsheremet/mruby-tbot.git'},  # test crush(4)
  {:git => 'https://github.com/iij/mruby-tempfile.git'},
  {:git => 'https://github.com/appPlant/mruby-terminal-table.git'},
  # {:git => 'https://github.com/mattn/mruby-thread.git'},  # Segmentation Fault
  ...
  # {:git => 'https://github.com/take-cheeze/mruby-uchardet.git'},  # compile error (c++11)
  ...
  # {:git => 'https://github.com/mattn/mruby-uv.git'},  # autogem.sh fail
  # {:git => 'https://github.com/mattn/mruby-v8.git'},  # need v8.h
  {:git => 'https://github.com/matsumotory/mruby-vedis.git'}, 
  # {:git => 'https://github.com/matsumotory/mruby-virtualing.git'},  # autoreconf
  ...
  # {:git => 'https://github.com/Asmod4n/mruby-wslay'}, # compile error (ntohl(),htons())
  # {:git => 'https://github.com/hone/mruby-yaml.git'},#build error(mrb_ary_len)
  {:git => 'https://github.com/katzer/mruby-yeah.git'}, # r3_tree_ error
  ...
  # {:git => 'https://github.com/dearblue/mruby-zstd.git'},# don't stop test
