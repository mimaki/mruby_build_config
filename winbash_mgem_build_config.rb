...
=begin
  ...
  # {:git => 'https://github.com/ppibburr/mruby-allocate.git'}, # build error (gem_test.c: undefimed mrb_mruby_allocate_gem_test)
  ...
  # {:git => 'https://github.com/matsumotory/mruby-changefinder.git'},  # test crush(5) abort, need Regexp
  ...
  # {:git => 'https://github.com/take-cheeze/mruby-clang-plugin.git'},  # build error (need -std=c++11)
  ...
  # {:git => 'https://github.com/inokappa/mruby-consul.git'}, # test crush(1) (UNIXServer or Regexp)
  ...
  # {:git => 'https://github.com/inokappa/mruby-datadog.git'},  # test crush(1) (UNIXServer or Regexp)
  ...
  # {:git => 'https://github.com/udzura/mruby-etcd.git'}, # test crush(1) (UNIXServer or Regexp)
  {:git => 'https://github.com/matsumotory/mruby-eventfd.git'},
  # {:git => 'https://github.com/matsumotory/mruby-fast-remote-check.git'}, # test KO(2) crush(3) (need CAP_NET_RAW?)
  {:git => 'https://github.com/mattn/mruby-fiberpool.git'},
  # {:git => 'https://github.com/takumakume/mruby-file-access.git'},  # test KO(5) (Access class methods (exits?, exists?, readable?, writable?, executable?))
  # {:git => 'https://github.com/ksss/mruby-file-stat.git'},  # test KO(9)
  # {:git => 'https://github.com/k0u5uk3/mruby-filemagic.git'}, # need magic.h
  # {:git => 'https://github.com/dabroz/mruby-float4.git'}, # SEGV
  ...
  # {:git => 'https://github.com/Asmod4n/mruby-getpass.git'}, # compile error (TCSASOFT undeclared)
  ...
  # {:git => 'https://github.com/matsumotory/mruby-httprequest.git'}, # test crush(1) (UNIXServer or Regexp)
  ...
  # {:git => 'https://github.com/jkutner/mruby-jvm.git', :inc => ["#{JDK_PATH}/include", "#{JDK_PATH}/include/linux"]}, # link error (dlopne, dlsym)
  ...
  # {:git => 'https://github.com/matsumotory/mruby-mrbgem-template.git'}, # test KO(1) crush(8) (UNIXSocket)
  ...
  # {:git => 'https://github.com/matsumotory/mruby-oauth.git'}, # test crush(1)
  ...
  # {:git => 'https://github.com/luisbebop/mruby-polarssl.git'},  # test crush(1) (UNIXServer)
  {:git => 'https://github.com/Asmod4n/mruby-poll.git'},
  # {:git => 'https://github.com/nsheremet/mruby-pong.git'},  # compile error (mrb_io)
...
=begin
  ...
  # {:git => 'https://github.com/nsheremet/mruby-smallhttp.git'}, # build error (mrb_io)
  ...
  # {:git => 'https://github.com/nsheremet/mruby-tbot.git'},  # test crush(5)
  ...
  # {:git => 'https://github.com/mattn/mruby-thread.git'},  # SEGV
