...
=begin
  ...
  # {:git => 'https://github.com/kyab/mruby-arduino.git'},  # g++ not found
  ...
  # {:git => 'https://github.com/sdottaka/mruby-bin-scite-mruby.git'},  # need g++
  ...
  # {:git => 'https://github.com/bggd/mruby-channel.git'},  # build error (g++ not found)
  ...
  # {:git => 'https://github.com/take-cheeze/mruby-glfw3.git'}, # g++
  ...
  # {:git => 'https://github.com/crimsonwoods/mruby-leapmotion.git'}, # g++ not found
  # {:git => 'https://github.com/take-cheeze/mruby-leveldb.git'}, # g++ not found
  ...
  # {:git => 'https://github.com/take-cheeze/mruby-marshal.git'}, # g++
  ...
  # {:git => 'https://github.com/dyama/mruby-rational.git'},  # p method error
...
=begin
  ...
  {:git => 'https://github.com/nsheremet/mruby-tbot.git'},
  ...
  {:git => 'https://github.com/matsumotory/mruby-timer-thread.git'},
  ...
  {:git => 'https://github.com/mattn/mruby-v8.git'},
  {:git => 'https://github.com/matsumotory/mruby-vedis.git'},
  {:git => 'https://github.com/matsumotory/mruby-virtualing.git'},
  {:git => 'https://github.com/ppibburr/mruby-webkit-1.git'},
  {:git => 'https://github.com/ppibburr/mruby-webkit-3.git'},
  {:git => 'https://github.com/sdottaka/mruby-win32ole.git'},
  {:git => 'https://github.com/mattn/mruby-winapp.git'},
  {:git => 'https://github.com/akiray03/mruby-WiringPi.git'},
  ...
  {:git => 'https://github.com/zeromq/mruby-zmq.git'},
  {:git => 'https://github.com/Asmod4n/mruby-zyre.git'},
=end
].each {|mgem|
  _git = mgem[:git]
