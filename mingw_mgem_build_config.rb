...
=begin
  ...
  # {:git => 'https://github.com/iij/mruby-aws-s3.git'},  # need sys/wait.h
  ...
  # {:git => 'https://github.com/inokappa/mruby-consul.git'}, # need sys/wait.h
  ...
  # {:git => 'https://github.com/udzura/mruby-etcd.git'}, # need sys/wait.h 
  ...
  # {:git => 'https://github.com/ksss/mruby-limits.git'}, # test crash(1)
  ...
  # {:git => 'https://github.com/mimaki/mruby-matrix.git', :branch => 'fix_test'},  # nees mruby-mtest/mrbgem.rake, original: 'https://github.com/listrophy/mruby-matrix.git'
  ...
  # {:git => 'https://github.com/matsumotory/mruby-oauth.git'}, # need sys/wait.h
  ...
  # {:git => 'https://github.com/mattn/mruby-require.git'}, # test abort(trace (most recent call last))
  ...
  # {:git => 'https://github.com/matsumotory/mruby-simplehttp.git'},  # need sys/wait.h
  # {:git => 'https://github.com/matsumotory/mruby-simplehttpserver.git'},  # need sys/eait.h
